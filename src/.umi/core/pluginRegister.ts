...
import * as Plugin_2 from '/Users/takashifukuda/antd-demo1/antd-demo2/antd-demo2/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: '/Users/takashifukuda/antd-demo1/antd-demo2/antd-demo2/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
